...
export const DataReleasePage: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 animate-fadeIn">
      ...
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-space-900 via-slate-900 to-space-900 border border-slate-800 rounded-3xl p-6 sm:p-8 space-y-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <div className="flex items-center space-x-2 text-cyan-400 font-mono text-xs uppercase tracking-wider mb-1">
              ...
              <span>ASKAP CRACO Data Release</span>
            </div>
          ...
          <div className="flex flex-wrap gap-1.5 bg-space-950 p-1.5 rounded-2xl border border-slate-800 text-xs font-mono">
            <button
      ...
      {filteredRrats.length === 0 ? (
        <div className="text-center py-16 bg-space-900/40 border border-slate-800 rounded-3xl space-y-3">
          <AlertCircle className="w-10 h-10 text-slate-500 mx-auto" />
          <h3 className="text-lg font-bold text-white">No RRATs match your criteria</h3>
          ...
          <button
            ...
            className="px-4 py-2 rounded-xl bg-cyan-600 hover:bg-cyan-500 text-space-950 font-semibold text-xs transition"
          >
            Reset All Filters
          </button>
        </div>
